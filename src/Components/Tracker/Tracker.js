        ...
        <div className='container my-5'>
            ...
            <div className='row g-3'>
                <div
                    ...
                    <h1 style={{ color: '#B4161B' }}><CountUp delay={5} end={3472} duration={5} /></h1>
                ...
                <div
                    ...
                    <h1 style={{ color: '#B4161B' }}><CountUp delay={5} end={20652} duration={10} /></h1>
                ...
                <div
                    ...
                    <h1 style={{ color: '#B4161B' }}><CountUp delay={5} end={195} duration={5} /></h1>
